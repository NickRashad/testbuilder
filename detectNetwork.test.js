...
describe('Maestro', function() {
  ...
  it('has a prefix of 5018 and a length of at least 12', function() {
    detectNetwork('501856789012').should.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of at most 19', function() {
    detectNetwork('5018567890123456789').should.equal('Maestro');
  });
  it('has a prefix of 5020 and a length of at least 12', function() {
    detectNetwork('502056789012').should.equal('Maestro');
  });
  it('has a prefix of 5020 and a length of at most 19', function() {
    detectNetwork('5020567890123456789').should.equal('Maestro');
  });
  it('has a prefix of 5038 and a length of at least 12', function() {
    detectNetwork('503856789012').should.equal('Maestro');
  });
  it('has a prefix of 5038 and a length of at most 19', function() {
    detectNetwork('5038567890123456789').should.equal('Maestro');
  });  
  it('has a prefix of 6304 and a length of at least 12', function() {
    detectNetwork('630456789012').should.equal('Maestro');
  });
  it('has a prefix of 6304 and a length of at most 19', function() {
